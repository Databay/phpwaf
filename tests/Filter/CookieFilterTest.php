...
class CookieFilterTest extends BaseTestCase
{
    ...
    public static function applyDataProvider(): array
    {
        return [
            ...
            [['FILTER_COOKIE_ACTIVE' => 'true', 'FILTER_COOKIE_PAYLOAD_FILES' => '[]', 'cookies' => []], true],
            [['FILTER_COOKIE_ACTIVE' => 'false', 'FILTER_COOKIE_PAYLOAD_FILES' => '[]', 'cookies' => []], true],
            [['FILTER_COOKIE_ACTIVE' => 'INVALID', 'FILTER_COOKIE_PAYLOAD_FILES' => '[]', 'cookies' => []], true],
