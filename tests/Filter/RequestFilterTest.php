...
class RequestFilterTest extends BaseTestCase
{
    ...
    public function testApply(array $input, bool $output): void
    {
        ...
        define('CONFIG', [
            ...
            'FILTER_REQUEST_BLOCKING_TYPE' => AbstractFilter::BLOCKING_TYPE_WARNING,
        ]);
        ...
        $this->assertNull((new RequestFilter())->apply($request));
    }
    ...
    public static function applyDataProvider(): array
    {
        return [
            ...
            [['FILTER_REQUEST_ACTIVE' => 'true', 'FILTER_REQUEST_PAYLOAD_FILES' => '[]', 'request' => []], true],
            [['FILTER_REQUEST_ACTIVE' => 'false', 'FILTER_REQUEST_PAYLOAD_FILES' => '[]', 'request' => []], true],
            [['FILTER_REQUEST_ACTIVE' => 'INVALID', 'FILTER_REQUEST_PAYLOAD_FILES' => '[]', 'request' => []], true],
            [['FILTER_REQUEST_ACTIVE' => 'true', 'FILTER_REQUEST_PAYLOAD_FILES' => '[]', 'request' => []], true],
            [['FILTER_REQUEST_ACTIVE' => 'false', 'FILTER_REQUEST_PAYLOAD_FILES' => '[]', 'request' => []], true],
            [['FILTER_REQUEST_ACTIVE' => 'INVALID', 'FILTER_REQUEST_PAYLOAD_FILES' => '[]', 'request' => []], true],
            [['FILTER_REQUEST_ACTIVE' => 'true', 'FILTER_REQUEST_PAYLOAD_FILES' => '', 'request' => []], true],
